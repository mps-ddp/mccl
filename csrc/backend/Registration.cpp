...
PYBIND11_MODULE(_C, m) {
    ...
    py::class_<mccl::Metrics::Summary>(m, "MetricsSummary")
        ...
        .def_readonly("p50_queue_wait_ms", &mccl::Metrics::Summary::p50_queue_wait_ms)
        .def_readonly("p95_queue_wait_ms", &mccl::Metrics::Summary::p95_queue_wait_ms)
        .def_readonly("p99_queue_wait_ms", &mccl::Metrics::Summary::p99_queue_wait_ms)
        .def_readonly("avg_send_queue_wait_ms", &mccl::Metrics::Summary::avg_send_queue_wait_ms)
        .def_readonly("avg_recv_queue_wait_ms", &mccl::Metrics::Summary::avg_recv_queue_wait_ms)
        .def_readonly("avg_send_ms", &mccl::Metrics::Summary::avg_send_ms)
        .def_readonly("avg_recv_ms", &mccl::Metrics::Summary::avg_recv_ms)
        .def_readonly("avg_stage_ms", &mccl::Metrics::Summary::avg_stage_ms)
        .def_readonly("avg_writeback_ms", &mccl::Metrics::Summary::avg_writeback_ms)
        .def_readonly("avg_backpressure_ms", &mccl::Metrics::Summary::avg_backpressure_ms)
        .def_readonly("p95_backpressure_ms", &mccl::Metrics::Summary::p95_backpressure_ms)
        .def_readonly("p99_backpressure_ms", &mccl::Metrics::Summary::p99_backpressure_ms)
        .def_readonly("pipeline_stall_count", &mccl::Metrics::Summary::pipeline_stall_count)
        .def_readonly("avg_pipeline_depth", &mccl::Metrics::Summary::avg_pipeline_depth)
        .def_readonly("max_pipeline_depth", &mccl::Metrics::Summary::max_pipeline_depth)
